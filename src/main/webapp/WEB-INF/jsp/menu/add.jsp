                                                                        ...
                                                                        <div class="form-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label class="control-label mb-10">成本</label>
                                                                                        <input type="number" class="form-control">
                                                                                    </div>
                                                                                </div>
                                                                                <!--/span-->
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <textarea class="form-control"  style="width: 572px;height: 200px;resize: none;"></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div  class="tab-struct custom-tab-1 mt-20">
                                                                                    ...
                                                                                    <ul role="tablist" class="nav nav-tabs">
                                                                                        <li class="active" role="presentation"><a aria-expanded="true"  data-toggle="tab" role="tab"  href="#home_7">初加工</a></li>
                                                                                        <li role="presentation" class=""><a  data-toggle="tab" role="tab" href="#profile_1" aria-expanded="false">精加工</a></li>
                                                                                        <li role="presentation" class=""><a  data-toggle="tab" role="tab" href="#profile_2" aria-expanded="false">烹饪</a></li>
                                                                                        <li role="presentation" class=""><a  data-toggle="tab" role="tab" href="#profile_3" aria-expanded="false">冷却</a></li>
                                                                                        <li role="presentation" class=""><a  data-toggle="tab"  role="tab" href="#profile_4" aria-expanded="false">包装</a></li>
                                                                                    </ul>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title" id="exampleModalLabel1">工序</h5>
                                </div>
