                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div >
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static">${contractOrder.contractOrderEndDate}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div  >
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static">${orderContract.orderContractNo}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div >
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static">${orderContract.orderContractName}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                                ...
                                                <div >
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"><fmt:formatDate value="${orderContract.orderContractDate}"  pattern="yyyy-MM-dd"/></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div >
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static">${orderContract.store.storeName}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
